...
export const FACET_BUNDLE_FORMAT_VERSION = 1;
...
export const FACET_BUNDLE_ARTIFACT_FORMAT_VERSION = 1;

export interface FacetBundleEntry {
	/** Content-addressed JavaScript filename relative to the manifest. */
