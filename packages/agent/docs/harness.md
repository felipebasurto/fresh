...
- **WP08 — named-branch and streaming forks (§2.7):** actionable handoff, not implemented; the current contract still defaults branch forks to `main`, does not copy application state for tree forks, and materializes source-sized snapshots.
